...
export class ELOCalculatorService {
  ...
  async testELOCalculations(): Promise<void> {
    ...
    this.logger.log(`Test 1 - Equal players (1500 vs 1500): Winner +${result1.winnerChange}, Loser ${result1.loserChange}`);
    ...
    this.logger.log(`Test 2 - Strong vs Weak (1800 vs 1200): Winner +${result2.winnerChange}, Loser ${result2.loserChange}`);
