...
public class MatchUIController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        opponentNameText.text = "Opponent"; // Would be set when match starts
    ...
    private void UpdateShieldBar(ShipController ship, Image shieldBar)
    {
        ...
        if (ship.IsShieldActive())
        {
            ...
            float shieldRatio = (float)ship.GetShieldHealth() / 50f; // Assuming max shield is 50
    ...
    private void UpdateCooldownIndicators()
    {
        ...
        if (weapon != null && fireCooldownIndicator != null)
        {
            ...
            if (fireCooldownText != null)
            {
                ...
                {
                    fireCooldownText.text = ((1f - cooldownProgress) * weapon.GetFireCooldown()).ToString("F1") + "s";
                }
            }
        }
        ...
        if (ability != null && abilityCooldownIndicator != null)
        {
            ...
            if (abilityCooldownText != null)
            {
                ...
                {
                    abilityCooldownText.text = ((1f - cooldownProgress) * ability.GetAbilityCooldown()).ToString("F1") + "s";
                }
            }
        }
    }
    ...
    private void UpdateDebugInfo()
    {
        if (fpsText != null)
        {
            fpsText.text = "FPS: " + GameStateManager.Instance.GetCurrentFPS();
        }
        
        if (pingText != null)
        {
            pingText.text = "Ping: " + (GameStateManager.Instance.GetSnapshotDelay() * 1000).ToString("F0") + "ms";
        }
    }
